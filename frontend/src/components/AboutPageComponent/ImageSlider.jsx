  ...
  return (
    <div className="w-full min-h-screen bg-[#fafafa]">
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10 mb-14">
          <header className="text-center">
            ...
            <p className="mt-6 text-lg md:text-xl text-[var(--apple-gray)] max-w-2xl mx-auto leading-relaxed">
          ...
          >
            {[...slides, ...slides].map((slide, index) => (
              ...
              >
                ...
                <h3 className="mt-4 text-sm font-semibold text-[var(--apple-black)] group-hover:text-red-600 transition-colors duration-200 leading-tight px-1">
                  {slide.name}
                </h3>
              </div>
            ))}
