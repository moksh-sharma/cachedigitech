  ...
  pages: [
    {
      ...
      tagline: "Delivering Intelligent, Secure & Always-On Network Infrastructure",
      heroImage: IMG("manages.webp"),
      bodyImage: IMG("manages.webp"),
      intro:
        "A high-performing, secure, and resilient network is the backbone of every digital enterprise. Cache Digitech's Network Managed Services provide end-to-end management of enterprise LAN, WAN, Wi-Fi, SD-WAN, Internet Edge, and Data Center Networks, ensuring seamless connectivity, enhanced security, and superior user experience across distributed locations.",
      introParagraphs: [
        "Our proactive, SLA-driven approach leverages 24x7 monitoring, automation, predictive analytics, ITIL best practices, and continuous optimization to maximize network availability, minimize downtime, and improve operational efficiency. Whether supporting branch offices, campuses, manufacturing facilities, retail outlets, or hybrid workplaces, we provide complete lifecycle ownership of your network infrastructure.",
      ],
      highlights: [],
      offerings: [],
      listSections: [
        ...
        {
          title: "LAN, WAN & Campus Network Management",
          items: [
            "LAN Administration",
            "WAN Operations",
            ...
            "MPLS & Internet Circuit Management",
        ...
        {
          title: "Network Configuration & Change Management",
          items: [
        ...
        },
        {
          ...
          items: [
            ...
            "Performance Trending & Forecasting",
          ],
        },
        {
          title: "SD-WAN & Next-Generation Networking",
          items: [
            "SD-WAN Operations",
            "WAN Optimization",
            "Internet Breakout Management",
            "Hybrid WAN Support",
        ...
        },
        {
          ...
          items: [
            ...
            "Automation-Led Network Operations",
            "Proactive Monitoring & Predictive Maintenance",
            "Nationwide Field Support Capabilities",
            "Centralized Governance & Executive Reporting",
        ...
        },
        {
          ...
          intro:
            "Our engineers manage enterprise networking environments powered by leading technology partners, including:",
          items: [
            "Cisco",
            "Juniper Networks",
            "Aruba (HPE)",
        ...
        },
        {
          ...
          items: [
            ...
            "Better User Experience Across Branches",
    ...
    },
    {
      ...
      intro:
        "Today's businesses depend on highly available, secure, and scalable IT infrastructure to support mission-critical applications and digital transformation initiatives. Cache Digitech delivers end-to-end Infrastructure Managed Services that ensure your server, storage, virtualization, and data center environments operate at peak performance while minimizing business risk and operational complexity.",
      introParagraphs: [
